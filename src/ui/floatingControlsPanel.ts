...
import { isWorkflowPaused, isWorkflowRunning, runWorkflow, stopWorkflow } from '../workflows/workflow';
...
export class FloatingControlsPanel {
  ...
  /**
   * Create a new FloatingControlsPanel
  ...
  private updatePanelContent(): void {
    ...
    const isRunning = isWorkflowRunning(this.context);
    const isPaused = isWorkflowPaused(this.context);
